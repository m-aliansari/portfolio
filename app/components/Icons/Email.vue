<template>
  ...
  >
    <g id="Layer_10" style="display: none">
      <g style="display: inline; opacity: 0.05">
        <g>
          ...
          <path
            d="M18,5c10.477,0,19,8.523,19,19s-8.523,19-19,19S-1,34.477-1,24S7.523,5,18,5 M18,4C6.954,4-2,12.954-2,24s8.954,20,20,20
    ...
    <g id="color">
      <path
        style="fill: #1e88e5"
        d="M34,42H14c-4.411,0-8-3.589-8-8V14c0-4.411,3.589-8,8-8h20c4.411,0,8,3.589,8,8v20
		C42,38.411,38.411,42,34,42z"
      />
      <path
        style="fill: #ffffff"
        d="M35.926,17.488L29.414,24l6.511,6.511C35.969,30.347,36,30.178,36,30V18
